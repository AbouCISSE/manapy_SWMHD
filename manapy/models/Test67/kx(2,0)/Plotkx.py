...
E4 = np.loadtxt("k96.txt", dtype='float', delimiter=',').T
...
ax.plot(E1x, E1h, "k:*",linewidth=2, markersize=1, label='t=0')
ax.plot(E2x, E2h, "r--",linewidth=2, markersize=6, label='t=2')
ax.plot(E3x, E3h, "r",linewidth=2, markersize=6, label='t=20')
ax.plot(E4x, E4h, "b.-.",linewidth=2, markersize=1, label='t=96')
ax.yaxis.set_major_formatter(FormatStrFormatter('%0.15g'))

#plt.yscale('log')
#plt.title(r'case $\mathbf{k} // (Ox)$', fontsize=20)
...
left, bottom, width, height = [0.7, 0.7, 0.1, 0.1]
#left, bottom, width, height = [0.1, 0.1, 0.1, 0.1]
ax2 = fig.add_axes([left, bottom, width, height])
ax2.plot(E3x, E3h, "r",linewidth=2, markersize=6)
ax2.plot(E4x, E4h, "b.-.",linewidth=2, markersize=1)
ax2.tick_params(top=False, bottom=False, left=False, right=False,
                labelleft=False, labelbottom=False)
ax2.yaxis.set_major_formatter(FormatStrFormatter('%0.15g'))
plt.savefig("hkx1.png") 
plt.show()
