...
if dim == 2:
    ...
    filename = os.path.join(MESH_DIR, "R0201.msh")
...
if RANK == 0:
    #Read gmsh file
    readmesh(filename, dim=dim, size=SIZE, periodic=[0,0])
...
ddm.plot_tricontourn( w_node["h"] + w_node["Z"], nodes.cellid, cells.center, nodes.vertex)
