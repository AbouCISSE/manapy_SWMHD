...
#File name
if dim == 2:
    #filename = os.path.join(MESH_DIR, "c1n.msh")
    #filename = os.path.join(MESH_DIR, "c8.msh")
    #filename = os.path.join(MESH_DIR, "c1.msh")
    #filename = os.path.join(MESH_DIR, "rpbc.msh")
    #filename = os.path.join(MESH_DIR, "rp1.msh")
    #filename = os.path.join(MESH_DIR, "rpbc1.msh")
    #filename = os.path.join(MESH_DIR, "rpbcRF.msh")
    #filename = os.path.join(MESH_DIR, "wave.msh")
    #filename = os.path.join(MESH_DIR, "TT.msh")
    #filename = os.path.join(MESH_DIR, "KH.msh")
    #filename = os.path.join(MESH_DIR, "DTS.msh")
    #filename = os.path.join(MESH_DIR, "sourcenp.msh")
    #filename = os.path.join(MESH_DIR, "source1.msh")
    #filename = os.path.join(MESH_DIR, "stationnary.msh")
    #filename = os.path.join(MESH_DIR, "MZ.msh")
    #filename = os.path.join(MESH_DIR, "npstationnary.msh")
    #filename = os.path.join(MESH_DIR, "frectangle.msh")
    #filename = os.path.join(MESH_DIR, "Rf0201.msh")
    #filename = os.path.join(MESH_DIR, "RNP0201.msh")
    #filename = os.path.join(MESH_DIR, "RP6.msh")
    filename = os.path.join(MESH_DIR, "EC3.msh")
    #filename = os.path.join(MESH_DIR, "u4.msh")
    #filename = os.path.join(MESH_DIR, "TP.msh")
    #filename = os.path.join(MESH_DIR, "PI.msh")
    #filename = os.path.join(MESH_DIR, "HH.msh")        
...
choix_source = 5
INTIAL = "waveg"
wave = "AL"  # "MG" : Magnéto-gravité et "AL" Alven
sourceT = "off"

k1  = 1. ; k2 = 0.; # vecteur d'onde  
B01 = 1. ; B02 = 0.2; # champ magnétique à l'équilibre 
ho = 20 ; grav = 1 ; epsilon = 1#e-2

if INTIAL == "wave":
    w_c =  ddm.initialisation_wave(w_c, cells.center, choix_wave, ho, grav, k1, k2, B01, B02, epsilon, wave)
    w_w =  ddm.initialisation_wave(w_c, cells.center, choix_wave, ho, grav, k1, k2, B01, B02, epsilon, wave)
elif sourceT == "on" :
    w_c = ddm.initialisation_source_terme(w_c, cells.center, choix_source, ho, grav, k1, k2, B01, B02, epsilon, wave)
    w_w = ddm.initialisation_source_terme(w_c, cells.center, choix_source, ho, grav, k1, k2, B01, B02, epsilon, wave)    
else :
...
#ddm.plot_tricontour( w_node["h"] + w_node["Z"], nodes.cellid, cells.center, nodes.vertex)
#ddm.plot_tripcolor( w_c["h"]+w_c["Z"], nodes.cellid, cells.center, nodes.vertex)
#ddm.plot_tricontour( w_c["h"], nodes.cellid, cells.center, nodes.vertex)
#ddm.plot_tricontour( w_c["hu"]/w_c["h"], nodes.cellid, cells.center, nodes.vertex)
#ddm.plot_tricontour( w_c["hv"]/w_c["h"], nodes.cellid, cells.center, nodes.vertex)
#ddm.plot_tricontour( w_c["hB1"]/w_c["h"], nodes.cellid, cells.center, nodes.vertex)
#ddm.plot_tricontour( w_c["hB2"]/w_c["h"], nodes.cellid, cells.center, nodes.vertex)
